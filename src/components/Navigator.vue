  ...
  >
    <div class="nav-cont" :class="{ pdd: scrollP > 0 }">
      ...
      <div class="menu-cont" :class="{ activated: open }">
        ...
        <a href="#nosotros" @click="open = false" class="menu-a">¿Quiénes somos?</a>
        <a href="#servicios" @click="open = false" class="menu-a">Servicios</a>
        <a href="#directorio" @click="open = false" class="menu-a">Directorio</a>
...
.sm-cont img {
  width: 1.354vw;
  filter: invert(39%) sepia(82%) saturate(381%) hue-rotate(139deg) brightness(91%) contrast(96%);
}
.sm-cont img.ylw {
...
@media (max-width: 768px) {
  ...
  .bars.filt {
    filter: invert(61%) sepia(16%) saturate(2846%) hue-rotate(337deg) brightness(100%) contrast(96%);
  }
  .activated {
